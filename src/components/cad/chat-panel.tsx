...
import { Sparkles, MessageSquare, Send, Square, Clock } from 'lucide-react'
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-2 border-t border-zinc-800/60">
        <div className="flex items-center gap-1.5">
          ...
          />
          {isStreaming ? (
            <Button size="sm" className="h-7 w-7 p-0 bg-rose-600 hover:bg-rose-500 shrink-0" onClick={handleStop}>
